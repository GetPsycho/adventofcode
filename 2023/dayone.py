...
calibrationListe = ('gsjgklneight6zqfz',
...
for calibElement in calibrationListe:
    #calibElement = "xhzs7rdphtx2htwo3"
    digitList = []
    countPerCharElem = 0
    ...
    if digitList.count == 1:
        print("cas nombre unique")
        countPerCharElem = digitList[0]*2
    else:
        print("cas 2 nombre")
        lastElem = len(digitList)
        countPerCharElem = str(digitList[0]) + str(digitList[lastElem-1])
    countGlobal += int(countPerCharElem)
    print("countGlobal progression: "+ str(countGlobal))
